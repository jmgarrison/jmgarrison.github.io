library catan_randomizer.web.main.generated_type_factory_maps;
...
import 'package:catan_randomizer/component/catan_board/catan_board.dart' as import_25;
import 'package:catan_randomizer/component/catan_hex/catan_hex.dart' as import_26;
import 'package:catan_randomizer/formatter/slice.dart' as import_27;
import 'package:catan_randomizer/uri/resource_url_resolver_wrapper.dart' as import_28;
...
final Map<Type, Function> typeFactories = <Type, Function>{
  ...
  import_25.CatanBoardComponent: () => new import_25.CatanBoardComponent(),
  import_26.CatanHexComponent: () => new import_26.CatanHexComponent(),
  import_27.SliceFilter: () => new import_27.SliceFilter(),
  import_28.ResourceUrlResolverWrapper: (a1, a2) => new import_28.ResourceUrlResolverWrapper(a1, a2),
...
final Map<Type, List<Key>> parameterKeys = {
  ...
  import_25.CatanBoardComponent: const[],
  import_26.CatanHexComponent: const[],
  import_27.SliceFilter: const[],
  import_28.ResourceUrlResolverWrapper: [_KEY_TypeToUriMapper, _KEY_ResourceResolverConfig],
