library catan_randomizer.web.main.generated_metadata;
...
import 'package:catan_randomizer/component/catan_board/catan_board.dart' as import_16;
import 'package:catan_randomizer/component/catan_hex/catan_hex.dart' as import_17;
import 'package:catan_randomizer/formatter/slice.dart' as import_18;
import 'package:catan_randomizer/uri/resource_url_resolver_wrapper.dart' as import_19;
...
final Map<Type, Object> typeAnnotations = {
  ...
  import_16.CatanBoardComponent: const [
    const import_2.Component(selector: 'catan-board', templateUrl: 'packages/catan_randomizer/component/catan_board/catan_board.html', cssUrl: 'packages/catan_randomizer/component/catan_board/catan_board.css'),
  ],
  import_17.CatanHexComponent: const [
    const import_2.Component(selector: 'catan-hex', templateUrl: 'packages/catan_randomizer/component/catan_hex/catan_hex.html', cssUrl: 'packages/catan_randomizer/component/catan_hex/catan_hex.css', map: const {'resource': '=>resource', 'value': '=>value'}),
  ],
  import_18.SliceFilter: const [
    const import_2.Formatter(name: 'slice'),
  ],
  import_19.ResourceUrlResolverWrapper: const [
    const import_1.Injectable(),
  ],
};
