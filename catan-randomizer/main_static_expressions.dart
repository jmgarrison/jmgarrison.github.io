library catan_randomizer.web.main.generated_expressions;
...
final Map<String, FieldGetter> getters = {
  ...
  r"hexes": (o) => o.hexes,
  r"hex": (o) => o.hex,
  r"randomize": (o) => o.randomize,
  r"hexClass": (o) => o.hexClass,
  r"valueClass": (o) => o.valueClass
};
final Map<String, FieldSetter> setters = {
  ...
  r"board": (o, v) => o.board = v,
  r"hexes": (o, v) => o.hexes = v,
  r"hex": (o, v) => o.hex = v
};
